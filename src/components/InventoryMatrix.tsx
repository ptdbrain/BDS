...
export function InventoryMatrix({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 glass-panel p-4 rounded-2xl border border-slate-800">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        <div className="glass-panel p-3.5 rounded-xl border border-slate-800 flex items-center justify-between">
          ...
          <div className="w-8 h-8 rounded-lg bg-slate-800 flex items-center justify-between justify-center text-slate-300 font-bold">
            100%
          </div>
        </div>
                          ...
                          >
                            ...
                            {isAvailable && currentRole === 'SALES' && (
                              <button
                                ...
                                className="w-full mt-2 py-1 px-2 rounded-lg bg-gradient-to-r from-amber-500 to-orange-500 text-slate-950 font-extrabold text-[10px] uppercase flex items-center justify-center space-x-1 shadow-md hover:from-amber-400 hover:to-orange-400 transition"
                              >
                                <Lock className="w-3 h-3" />
                                <span>Khóa 30 Phút</span>
                              </button>
                            )}
                          </div>
                        );
